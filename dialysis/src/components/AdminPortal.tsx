  ...
  return (
    <div className={`min-h-screen bg-slate-50 flex font-sans text-slate-800 antialiased selection:bg-emerald-500/20 ${tourActive ? 'pt-20' : ''}`}>
      ...
      <motion.aside
        ...
        className="
          bg-emerald-950 text-white flex flex-col
          shadow-2xl z-40 overflow-hidden whitespace-nowrap
      ...
      >
        ...
        <div className="p-6 flex items-center justify-between border-b border-emerald-800/50 min-h-[80px]">
          ...
          <div className="flex items-center gap-3 overflow-hidden">
            <div className="w-10 h-10 rounded-2xl bg-yellow-400 text-emerald-950 flex items-center justify-center font-black shrink-0">
              {role === 'doctor' ? (
                <Stethoscope size={20} />
              ) : (
                <Hospital size={20} />
            ...
            <div className="overflow-hidden">
              <p className="text-[10px] text-yellow-400 uppercase tracking-widest font-semibold">
                {role === 'doctor'
                  ? 'Nephrologist Portal'
                  : 'PhilHealth HCI Portal'}
              </p>

              <h1 className="font-bold text-lg leading-tight text-white truncate">
                St. Jude Renal Center
              </h1>
            </div>
          </div>
            ...
            return (
              <button
                ...
                className={`
                  ...
                  ${
                    isActive
                      ? 'bg-yellow-400 text-emerald-950 shadow-inner'
                ...
                {Boolean(item.badge) && item.badge > 0 && (
                  <span
                    className={`
                      ...
                      ${
                        isActive
                          ? 'bg-emerald-950 text-yellow-400'
        ...
        {/* FOOTER */}
        <div className="space-y-4 p-4 border-t border-emerald-800/50">
          
          {/* Status */}
          <div className="p-3 bg-emerald-900/30 rounded-2xl border border-emerald-800/20 text-[10px] font-bold text-slate-300">
            
            <div className="flex items-center justify-between mb-2">
              <span className="flex items-center gap-1.5 uppercase tracking-wider text-emerald-200">
                <Database
                  size={12}
                  className={
                    isSupabaseConnected
              ...
              <span
                className={`
                  ...
                  ${
                    isSupabaseConnected
                      ? 'bg-emerald-400 shadow shadow-emerald-400'
                      : 'bg-yellow-400 shadow shadow-yellow-400'
                  }
                `}
              />
            </div>
            ...
            <p className="leading-relaxed text-[11px] text-slate-300">
              {isSupabaseConnected
                ? 'Clinical records synchronized with Supabase cloud tables.'
                : 'Running in local sandbox database mode.'}
            </p>
          </div>
        </div>
      </motion.aside>
