...
export default function RecordsList({
  ...
  // Custom Modal States for Deletion Flow
  ...
  // Executes the deletion sequence when confirmed via modal
  ...
  return (
    <div className="space-y-6">
      ...
      */}
      ...
      {/* DELETION CONFIRMATION DIALOG MODAL PANEL */}
      <AnimatePresence>
        {showDeleteConfirm && (
            ...
            >
              ...
              <div>
                ...
                <p className="text-slate-400 text-xs mt-1.5 leading-relaxed">
                  Are you absolutely sure you want to permanently remove this dialysis application profile? This configuration parameter cannot be undone.
                </p>
              </div>
