...
export default function PatientRegistryView({
  ...
  const handleFinalDelete = () => {
    if (recordToDelete) {
      onDeletePatient(recordToDelete);
      if (selectedReg?.id === recordToDelete) {
        setSelectedReg(null);
      }
    }
            ...
            >
              ...
              <div>
                ...
                <p className="text-slate-400 text-xs mt-1.5 leading-relaxed">
                  Are you absolutely sure you want to delete this dialysis application profile? This action cannot be undone.
                </p>
              </div>
